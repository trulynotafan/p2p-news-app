    ...
    (function (Buffer) {
      (function () {
        ...
        function blog_app (identity) {
          ...
          // Global state
          let store; let ds_manager; let pairing_manager; let pairing_result = null
 ...
 */
  ...
  }, { 'base64-js': 3, buffer: 5, ieee754: 7 }],
  ...
  ******************************************************************************/
    ...
    (function (__filename) {
      (function () {
        ...
        if (!STATE || typeof STATE !== 'function') {
          if (window.STATE && typeof window.STATE === 'function') {
            STATE = window.STATE
          } else {
            console.warn('STATE module not found via require or window')
            STATE = null
          }
        }

        const statedb = STATE ? STATE(__filename) : null
        const { get } = statedb ? statedb(fallback_module) : { get: async () => ({ id: 0, sdb: { drive: { get: async () => null, put: async () => { } }, watch: async () => [] } }) }

        module.exports = function news_app (vault, existing_api) {
  ...
  `
          ...
          // Initialize App
          init(vault, sidebar, main, existing_api)

          return container
        }

        async function init (vault, sidebarEl, mainEl, existing_api) {
          try {
            // Initialize API
            const api = existing_api || blog_app(vault)
  ...
  }, { './wrapper': 10, STATE: 4, 'p2p-news-app': 1 }],
  10: [function (require, module, exports) {
    ...
    }).call(this, '/web/node_modules/news/wrapper.js')
  }, { './graphdb': 8, STATE: 4, 'graph-explorer': 6 }],
  11: [function (require, module, exports) {
    (function (Buffer) {
      (function () {
        ...
        const blog_app = require('p2p-news-app')
        const news_component = require('news')
  ...
  `
          ...
          async function render_view (view, ...args) {
            ...
            const renderers = {
              news: async () => {
                view_el.innerHTML = ''
                // Pass existing api to news component
                const app = news_component(vault, api)
                view_el.appendChild(app)
              },
  ...
  }, { buffer: 5, news: 9, 'p2p-news-app': 1 }]
}, {}, [11])
