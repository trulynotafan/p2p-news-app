...
const init_blog = async (options) => {
  const { username, invite_code } = options
  ...
  ds_manager = datastructure_manager()
  ...
  if (invite_code) {
    ...
    const result = await ds_manager.join_with_invite_and_init(invite_code, swarm_instance, store)
