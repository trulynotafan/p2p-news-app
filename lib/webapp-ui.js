...
async function render_view (view, ...args) {
  ...
  // A bit of "separate" UI for app_audit.
  // The vault audit UI will be in websys-UI along with the bar.
  // @ TODO Implement separate UI bar for vault UI.
...
async function handle_reset_all_data () {
  ...
  // File system cleanup helpers (flattened structure)
