...
async function start_native_peer (options = {}) {
  ...
  const mnemonicData = await create_mnemonic_keypair({
    namespace: 'noisekeys',
    name: 'noise'
  })
  
  console.log(label, 'Generated mnemonic:', mnemonicData.mnemonic)
  console.log(label, 'Peer key:', mnemonicData.keypair.publicKey.toString('hex'))
  ...
  const swarm = new Hyperswarm({ key_pair: mnemonicData.keypair })
