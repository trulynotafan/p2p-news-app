...
// fucntion will now use options, to match the native peer design.. 
          ...
          const protocol_msg = identity_channel.addMessage({
            ...
            onmessage: async (message) => {
              try {
                if (message.type === 'protocol') {
                ...
                } else if (message.type === 'feedkey' && !has_received_key) {
                  ...
                  const hexKey = key_buffer.toString('hex')
