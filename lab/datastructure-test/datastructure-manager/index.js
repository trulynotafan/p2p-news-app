...
const { create_autodrive, get_local_core } = require('../../../src/node_modules/autodrive')
const autobase = require('../../../node_modules/autobase')
...
const create_datastructure_manager = () => {
  ...
  const create_invite_with_pairing = async (swarm, primary_structure_name) => {
    const { create_pairing_manager } = require('../pairing-manager')
    ...
    const pairing_manager = create_pairing_manager(ds_manager_interface, swarm)
  ...
  const join_with_invite_and_init = async (invite_code, swarm, store_instance) => {
    const { create_pairing_manager } = require('../pairing-manager')
    ...
    const result = await pairing_manager.join_with_invite({ invite_code, store: store_instance })
...
module.exports = { create_datastructure_manager }
