// THIS FILE IS RAN IN BROWSER ENVIRONMENT TO TEST BLINDPAIRING / BLINDPAIRINGCORE / AUTODRIVE / ITS WRITER ADDITON MECHANISM
// SODIUM JS PLUS IS USED TO EXTEND SODIUM TO ADD SUPPORT CRYPTO FUNCTIONS USED BY BLIND-PAIRING
...
async function start_test() {
  ...
  try {
    // Device 1 creates identity and invite
    await device1_create_identity()
    
    // Device 2 joins after device 1 is ready
